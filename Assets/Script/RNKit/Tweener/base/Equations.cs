...
public class Equations
{
    ...
    /// <returns></returns>
    public delegate float Function(float percentage, float start, float offset);
    ...
    public static Function getEquation(Enum e)
    {
        ...
        Debug.LogError("e is None");
        return null;
    }


    //
    public static float linear(float p, float b, float c)
    {
        return c * p + b;
    }
    
    public static float sin(float p, float b, float c)
    {
        return Mathf.Sin(p * Mathf.PI * 2.0f) * c + b;
    }

    public static float cos(float p, float b, float c)
    {
        return Mathf.Cos(p * Mathf.PI * 2.0f) * c + b;
    }

    public static float sinOnePi(float p, float b, float c)
    {
        return Mathf.Sin(p * Mathf.PI) * c + b;
    }

    public static float cosOnePi(float p, float b, float c)
    {
        return Mathf.Cos(p * Mathf.PI) * c + b;
    }

    public static float spring(float p, float b, float c)
    {
    ...
    public static float inOutQuad(float p, float b, float c)
    {
        p *= 2f;
        if (p < 1f)
            return c / 2f * p * p + b;
    ...
    public static float outInQuad(float p, float b, float c)
    {
        if (p < 0.5f)
    ...
    public static float inOutCubic(float p, float b, float c)
    {
        p *= 2f;
        if (p < 1f)
            return c / 2f * p * p * p + b;
    ...
    public static float outInCubic(float p, float b, float c)
    {
        if (p < 0.5f)
    ...
    public static float inOutQuart(float p, float b, float c)
    {
        p *= 2f;
        if (p < 1f)
    ...
    public static float outInQuart(float p, float b, float c)
    {
        if (p < 0.5f)
    ...
    public static float inOutQuint(float p, float b, float c)
    {
        p *= 2f;
        if (p < 1f)
    ...
    public static float outInQuint(float p, float b, float c)
    {
        if (p < 0.5f)
    ...
    public static float inOutSine(float p, float b, float c)
    {
        return -c / 2f * (Mathf.Cos(Mathf.PI * p) - 1f) + b;
    }

    public static float outInSine(float p, float b, float c)
    {
        if (p < 0.5f)
    ...
    public static float inOutExpo(float p, float b, float c)
    {
        if (p == 0f)
            return b;
        if (p == 1f)
    ...
    public static float outInExpo(float p, float b, float c)
    {
        if (p < 0.5f)
    ...
    public static float inOutCirc(float p, float b, float c)
    {
        p *= 2f;
        if (p < 1f)
    ...
    public static float outInCirc(float p, float b, float c)
    {
        if (p < 0.5f)
    ...
    public static float inOutBounce(float p, float b, float c)
    {
        if (p < 0.5f)
    ...
    public static float outInBounce(float p, float b, float c)
    {
        if (p < 0.5f)
    ...
    public static float inOutElastic(float p, float b, float c)
    {
        if (p == 0f)
            return b;
        if ((p /= 0.5f) == 2f)
    ...
    public static float outInElastic(float p, float b, float c)
    {
        if (p < 0.5f)
    ...
    public static float inOutBack(float p, float b, float c)
    {
        float s = 1.70158f;
        if ((p /= 0.5f) < 1)
    ...
    public static float outInBack(float p, float b, float c)
    {
        if (p < 0.5f)
    ...
    public static float inOutBack2(float p, float b, float c)
    {
        float s = 1.70158f * 2;
        if ((p /= 0.5f) < 1)
            return c / 2f * (p * p * (((s *= (1.525f)) + 1f) * p - s)) + b;
    ...
    public static float outInBack2(float p, float b, float c)
    {
        if (p < 0.5f)
            return outBack(p * 2.0f, b, c / 2.0f);
        return inBack((p * 2.0f) - 1f, b + c / 2.0f, c / 2.0f);
